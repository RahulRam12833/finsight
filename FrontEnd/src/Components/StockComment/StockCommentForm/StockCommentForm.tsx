...
const StockCommentForm = ({ handleComment }: Props) => {
  ...
  return (
    <form className="mt-4 ml-4 w-md" onSubmit={handleSubmit(handleComment)}>
      <input
        type="text"
        id="title"
      ...
      <button
        type="submit"
        className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white  rounded-lg bg-green-400 focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
      >
        Post comment
      </button>
    </form>
