...
const PortfolioCard = ({ portfolioItem, onPortfolioDelete }: Props) => {
  return (
    <>
      <div className=" flex w-full flex-col space-y-4 rounded-2xl border border-blue-100 bg-white/80 p-8 text-center text-indigo-950 shadow-[0_10px_30px_rgba(37,99,235,0.10)] backdrop-blur-sm">
        <Link
